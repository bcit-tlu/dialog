"""Quality Auditor agent — cross-references questions against source chunks."""

from __future__ import annotations

import json

from dialog.agents.utils.agent_states import AgentState, AuditFlag
...
def create_quality_auditor(llm):
    """Factory: create a quality auditor node that captures the given LLM."""

    def quality_auditor_node(state: AgentState) -> dict:
